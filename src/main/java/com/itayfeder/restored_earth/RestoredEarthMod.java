package com.itayfeder.restored_earth;
...
@Mod(RestoredEarthMod.MOD_ID)
public class RestoredEarthMod
{
    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();
    public static final String MOD_ID = "restored_earth";

    public RestoredEarthMod() {

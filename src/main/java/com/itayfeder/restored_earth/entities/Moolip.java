...
public class Moolip extends Cow implements Shearable, net.minecraftforge.common.IForgeShearable {
    private MobEffect effect;
    private int effectDuration;
    private UUID lastLightningBoltUUID;

    public Moolip(EntityType<? extends Moolip> p_i50257_1_, Level p_i50257_2_) {
    ...
    @Override
    public Moolip getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {

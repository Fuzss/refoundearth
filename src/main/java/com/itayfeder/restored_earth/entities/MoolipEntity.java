...
public class MoolipEntity extends CowEntity implements IShearable, net.minecraftforge.common.IForgeShearable {
    private Effect effect;
    private int effectDuration;
    private UUID lastLightningBoltUUID;

    public MoolipEntity(EntityType<? extends MoolipEntity> p_i50257_1_, World p_i50257_2_) {
    ...
    public ActionResultType mobInteract(PlayerEntity p_230254_1_, Hand p_230254_2_) {
        ...
        if (itemstack.getItem() == Items.BOWL && !this.isBaby()) {
            ...
            FlowerBlock block = (FlowerBlock) BlockInit.PINK_DAISY;
    ...
    public void shear(SoundCategory p_230263_1_) {
        ...
        if (!this.level.isClientSide()) {
            ...
            for(int i = 0; i < 5; ++i) {
                this.level.addFreshEntity(new ItemEntity(this.level, this.getX(), this.getY(1.0D), this.getZ(), new ItemStack(ItemInit.PINK_DAISY)));
            }
        }
    ...
    public java.util.List<ItemStack> onSheared(@javax.annotation.Nullable PlayerEntity player, @javax.annotation.Nonnull ItemStack item, World world, BlockPos pos, int fortune) {
        ...
        if (!world.isClientSide()) {
            ...
            for (int i = 0; i < 5; ++i) {
                items.add(new ItemStack(ItemInit.PINK_DAISY));
            }
    ...
    @Override
    public MoolipEntity getBreedOffspring(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
        return EntityInit.MOOLIP.create(p_241840_1_);
    }
}
...
public class ItemInit {
    public static final Item MUD_BUCKET = new BucketItem(FluidInit.MUD, (new Item.Properties()).craftRemainder(Items.BUCKET).stacksTo(1).tab(CreativeModeTab.TAB_MISC));
    public static final Item FANCY_FEATHER = new Item((new Item.Properties()).tab(CreativeModeTab.TAB_MATERIALS));
    public static final Item HORN = new Item((new Item.Properties()).tab(CreativeModeTab.TAB_MATERIALS));

    public static final Item RAINBOW_WOOL = new BlockItem(BlockInit.RAINBOW_WOOL, (new Item.Properties()).tab(CreativeModeTab.TAB_BUILDING_BLOCKS));
    public static final Item RAINBOW_CARPET = new BlockItem(BlockInit.RAINBOW_CARPET, (new Item.Properties()).tab(CreativeModeTab.TAB_DECORATIONS));
    public static final Item RAINBOW_BED = new BlockItem(BlockInit.RAINBOW_BED, (new Item.Properties()).tab(CreativeModeTab.TAB_DECORATIONS));
    public static final Item BUTTERCUP = new BlockItem(BlockInit.BUTTERCUP, (new Item.Properties()).tab(CreativeModeTab.TAB_DECORATIONS));
    public static final Item PINK_DAISY = new BlockItem(BlockInit.PINK_DAISY, (new Item.Properties()).tab(CreativeModeTab.TAB_DECORATIONS));
    public static final Item CARVED_MELON = new BlockItem(BlockInit.CARVED_MELON, (new Item.Properties()).tab(CreativeModeTab.TAB_BUILDING_BLOCKS));

    public static final Item MUDDY_PIG_SPAWN_EGG = new SpawnEggItem(EntityInit.MUDDY_PIG, 15771042, 5912611, (new Item.Properties()).tab(CreativeModeTab.TAB_MISC));
    public static final Item WOOLY_COW_SPAWN_EGG = new SpawnEggItem(EntityInit.WOOLY_COW, 13926720, 16634012, (new Item.Properties()).tab(CreativeModeTab.TAB_MISC));
    public static final Item JUMBO_RABBIT_SPAWN_EGG = new SpawnEggItem(EntityInit.JUMBO_RABBIT, 14261130, 15846073, (new Item.Properties()).tab(CreativeModeTab.TAB_MISC));
    public static final Item FANCY_CHICKEN_SPAWN_EGG = new SpawnEggItem(EntityInit.FANCY_CHICKEN, 2504745, 16032275, (new Item.Properties()).tab(CreativeModeTab.TAB_MISC));
    public static final Item RAINBOW_SHEEP_SPAWN_EGG = new SpawnEggItem(EntityInit.RAINBOW_SHEEP, 16777215, 16777215, (new Item.Properties()).tab(CreativeModeTab.TAB_MISC));
    public static final Item JOLLY_LLAMA_SPAWN_EGG = new SpawnEggItem(EntityInit.JOLLY_LLAMA, 6764327, 2446631, (new Item.Properties()).tab(CreativeModeTab.TAB_MISC));
    public static final Item VILER_WITCH_SPAWN_EGG = new SpawnEggItem(EntityInit.VILER_WITCH, 11247501, 1316907, (new Item.Properties()).tab(CreativeModeTab.TAB_MISC));
    public static final Item TROPICAL_SLIME_SPAWN_EGG = new SpawnEggItem(EntityInit.TROPICAL_SLIME, 2514301, 16036882, (new Item.Properties()).tab(CreativeModeTab.TAB_MISC));
    public static final Item MOOBLOOM_SPAWN_EGG = new SpawnEggItem(EntityInit.MOOBLOOM, 16635136, 16644026, (new Item.Properties()).tab(CreativeModeTab.TAB_MISC));

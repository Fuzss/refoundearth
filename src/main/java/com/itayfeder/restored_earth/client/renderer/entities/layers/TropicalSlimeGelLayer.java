...
public class TropicalSlimeGelLayer<T extends LivingEntity> extends LayerRenderer<T, TropicalSlimeModel<T>> {
    private final TropicalSlimeModel<T> model = new TropicalSlimeModel<>(true);

    public TropicalSlimeGelLayer(IEntityRenderer<T, TropicalSlimeModel<T>> p_i50923_1_) {
        super(p_i50923_1_);
    }

...
public class FancyChickenModel <T extends Entity> extends AgeableListModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("head", CubeListBuilder.create()
                ...
                .texOffs(0, 22).addBox(0.0F, -10.0F, -3.0F, 0.0F, 5.0F, 5.0F), PartPose.offset(0.0F, 13.0F, -4.0F));

        partdefinition.addOrReplaceChild("beak", CubeListBuilder.create().texOffs(14, 0).addBox(-2.0F, -4.0F, -4.0F, 4.0F, 2.0F, 2.0F), PartPose.offset(0.0F, 13.0F, -4.0F));

        partdefinition.addOrReplaceChild("red_thing", CubeListBuilder.create().texOffs(14, 4).addBox(-0.5F, -2.0F, -4.0F, 1.0F, 2.0F, 2.0F), PartPose.offset(0.0F, 13.0F, -4.0F));

        partdefinition.addOrReplaceChild("body", CubeListBuilder.create()
                .texOffs(0, 9).addBox(-3.0F, -4.0F, -3.0F, 6.0F, 8.0F, 6.0F)
                .texOffs(14, 15).addBox(0.0F, 4.0F, 1.0F, 0.0F, 7.0F, 10.0F), PartPose.offsetAndRotation(0.0F, 14.0F, 0.0F, ((float)Math.PI / 2F), 0.0F, 0.0F));

        CubeListBuilder cubelistbuilder = CubeListBuilder.create().texOffs(26, 0).addBox(-2.0F, 0.0F, -3.0F, 3.0F, 7.0F, 3.0F);
        ...
        partdefinition.addOrReplaceChild("right_wing", CubeListBuilder.create().texOffs(24, 13).addBox(0.0F, 0.0F, -3.0F, 1.0F, 4.0F, 6.0F), PartPose.offset(-4.0F, 11.0F, 0.0F));

        partdefinition.addOrReplaceChild("left_wing", CubeListBuilder.create().texOffs(24, 13).addBox(-1.0F, 0.0F, -3.0F, 1.0F, 4.0F, 6.0F), PartPose.offset(4.0F, 11.0F, 0.0F));

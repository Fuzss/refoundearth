...
public class JollyLlamaModel<T extends AbstractChestedHorse> extends EntityModel<T> {
    ...
    public JollyLlamaModel(ModelPart p_170724_) {
    ...
    public static LayerDefinition createBodyLayer(CubeDeformation p_170726_) {
        ...
        CubeDeformation deform1 = p_170726_.extend(0.1F);
        partdefinition.addOrReplaceChild("head", CubeListBuilder.create()
                ...
                .texOffs(89, 44).addBox("head_decor",-4.0F, -15.0F, -7.0F, 8.0F, 12.0F, 8.0F, deform1)
                .texOffs(28, 50).addBox("neck_decor", -2.0F, -14.0F, -10.0F, 4.0F, 4.0F, 9.0F, deform1)
                .texOffs(82, 30).addBox("right_horm",4.0F, -29.75F, -2.0F, 7.0F, 16.0F, 0.0F)
                .texOffs(75, 30).addBox("left_horm", -11.0F, -29.75F, -2.0F, 7.0F, 16.0F, 0.0F), PartPose.offset(0.0F, 7.0F, -6.0F));
        partdefinition.addOrReplaceChild("body", CubeListBuilder.create()
                .texOffs(29, 0).addBox(-6.0F, -10.0F, -7.0F, 12.0F, 18.0F, 10.0F, p_170726_)
                .texOffs(84, 0).addBox(-6.0F, -10.0F, -7.0F, 12.0F, 18.0F, 10.0F, p_170726_.extend(0.5F)), PartPose.offsetAndRotation(0.0F, 5.0F, 2.0F, ((float)Math.PI / 2F), 0.0F, 0.0F));

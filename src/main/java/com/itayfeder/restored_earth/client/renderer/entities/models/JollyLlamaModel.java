...
public class JollyLlamaModel<T extends AbstractChestedHorseEntity> extends EntityModel<T> {
    ...
    public JollyLlamaModel(float p_i47226_1_) {
        ...
        head.texOffs(0, 0).addBox(-2.0F, -14.0F, -10.0F, 4.0F, 4.0F, 9.0F, 0.0F, true);
        head.texOffs(0, 14).addBox(-4.0F, -16.0F, -6.0F, 8.0F, 18.0F, 6.0F, 0.0F, true);
        head.texOffs(17, 0).addBox(1.0F, -19.0F, -4.0F, 3.0F, 3.0F, 2.0F, 0.0F, true);
        head.texOffs(17, 0).addBox(-4.0F, -19.0F, -4.0F, 3.0F, 3.0F, 2.0F, 0.0F, true);
        head.texOffs(89, 44).addBox(-4.0F, -15.0F, -7.0F, 8.0F, 12.0F, 8.0F, 0.1F, true);
        head.texOffs(28, 50).addBox(-2.0F, -14.0F, -10.0F, 4.0F, 4.0F, 9.0F, 0.1F, true);
        head.texOffs(82, 30).addBox(4.0F, -29.75F, -2.0F, 7.0F, 16.0F, 0.0F, 0.0F, false);
        head.texOffs(75, 30).addBox(-11.0F, -29.75F, -2.0F, 7.0F, 16.0F, 0.0F, 0.0F, false);

        body = new ModelRenderer(this);
        body.setPos(0.0F, 5.0F, 2.0F);
        body.texOffs(29, 0).addBox(-6.0F, -10.0F, -7.0F, 12.0F, 18.0F, 10.0F, 0.0F, true);
        body.texOffs(84, 0).addBox(-6.0F, -10.0F, -7.0F, 12.0F, 18.0F, 10.0F, 0.5F, true);

        leg0 = new ModelRenderer(this);
        leg0.setPos(3.5F, 10.0F, 6.0F);
        leg0.texOffs(29, 29).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 14.0F, 4.0F, 0.0F, true);

        leg1 = new ModelRenderer(this);
        leg1.setPos(-3.5F, 10.0F, 6.0F);
        leg1.texOffs(29, 29).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 14.0F, 4.0F, 0.0F, true);

        leg2 = new ModelRenderer(this);
        leg2.setPos(3.5F, 10.0F, -5.0F);
        leg2.texOffs(29, 29).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 14.0F, 4.0F, 0.0F, true);

        leg3 = new ModelRenderer(this);
        leg3.setPos(-3.5F, 10.0F, -5.0F);
        leg3.texOffs(29, 29).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 14.0F, 4.0F, 0.0F, true);

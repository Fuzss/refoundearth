...
public class MoolipFlowerLayer<T extends MoolipEntity> extends LayerRenderer<T, CowModel<T>> {
    public MoolipFlowerLayer(IEntityRenderer<T, CowModel<T>> p_i50931_1_) {
        super(p_i50931_1_);
    }

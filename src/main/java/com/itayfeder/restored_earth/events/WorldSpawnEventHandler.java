...
public class WorldSpawnEventHandler {
    ...
    public static void ReplaceCurrentMobSpawnWithNew(MobSpawnInfoBuilder builder, MobCategory spawnType, EntityType<?> replacedEntity, EntityType<?> replacingEntity) {

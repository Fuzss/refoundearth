...
public class TropicalSlimeOuterLayer<T extends LivingEntity> extends RenderLayer<T, TropicalSlimeModel<T>> {
    private final EntityModel<T> model;

    public TropicalSlimeOuterLayer(RenderLayerParent<T, TropicalSlimeModel<T>> p_174536_, EntityModelSet p_174537_) {
        super(p_174536_);
        this.model = new TropicalSlimeModel<>(p_174537_.bakeLayer(ModModelLayers.TROPICAL_SLIME_OUTER));
    }
